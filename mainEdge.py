...
def main(args):
    ...
    if args.training_type is 'Train':
        ...
        FeatExtor = init_model(net=FeatExtmodel, init_type = args.init_type, pretrain=args.pretrain, restore=FeatExt_restore, parallel_reload=True)
        DepthEstor= init_model(net=DepthEstmodel, init_type = args.init_type, pretrain=False,restore=DepthEst_restore, parallel_reload=True)
        FeatEmbder= init_model(net=FeatEmbdmodel, init_type = args.init_type, pretrain=args.pretrain,restore=FeatEmbd_restore, parallel_reload=False)
