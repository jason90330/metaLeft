...
model_urls = {
    ...
    'efficientnet_lite0_extr': 'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/efficientnet_lite0_ra-37913777.pth',
    'efficientnet_lite0_embd': 'https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/efficientnet_lite0_ra-37913777.pth',
...
class GenEfficientNet_FeatExtractor(nn.Module):
    ...
    def __init__(self, block_args, num_classes=1000, in_chans=6, num_features=1280, stem_size=32, fix_stem=False,
                 ...
                 weight_init='goog'):
        super(GenEfficientNet_FeatExtractor, self).__init__()
...
class GenEfficientNet_FeatEmbedder(nn.Module):
    """ Generic EfficientNets
    ...
    def __init__(self, block_args, num_classes=1000, in_chans=3, num_features=1280, stem_size=32, fix_stem=False,
                 ...
                 se_kwargs=None, norm_layer=nn.BatchNorm2d, norm_kwargs=None,
                 weight_init='goog'):
        super(GenEfficientNet_FeatEmbedder, self).__init__()
        self.drop_rate = drop_rate
...
def efficientnet_lite0_extr(pretrained=False, **kwargs):
    """ efficientnet_lite0_extr """
    model = _gen_efficientnet_lite(
        'efficientnet_lite0_extr', channel_multiplier=1.0, depth_multiplier=1.0, pretrained=pretrained, **kwargs)
    return model

def efficientnet_lite0_embd(pretrained=False, **kwargs):
    """ efficientnet_lite0_embd """
    model = _gen_efficientnet_lite(
