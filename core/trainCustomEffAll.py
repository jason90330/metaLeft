...
def Train(args, FeatExtor, DepthEstor, FeatEmbder,
    ...
    for epoch in range(args.epochs):
        ...
        for step in range(iternum):
            ...
            # cat_img1_fake, depth_img1_fake, lab1_fake = next(data1_real)#next(data1_fake)

            # cat_img2_real, depth_img2_real, lab2_real = next(data2_real)
            # cat_img2_fake, depth_img2_fake, lab2_fake = next(data2_real)#next(data2_fake)

            # cat_img3_real, depth_img3_real, lab3_real = next(data3_real)
            # cat_img3_fake, depth_img3_fake, lab3_fake = next(data3_real)#next(data3_fake)
           ...
           #============ doamin list augmentation ============# 
            ...
            catimglist = [cat_img1,cat_img2,cat_img3]
